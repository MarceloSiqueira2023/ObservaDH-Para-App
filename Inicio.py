...
def main_page_content():
    ...
    st.markdown("""
        <p style='font-size: 1.1em; line-height: 1.6;'>
            Este projeto visa promover a transparência e o acesso a informações cruciais sobre a situação dos direitos humanos em diversas populações no Pará, apoiando análises e tomada de decisões baseadas em dados concretos.
    ...
    st.write("Você pode explorar os dados de forma interativa, filtrando e visualizando diferentes indicadores sociais e de direitos humanos.")
    st.write("Em cada gráfico, você pode expandir o tamanho para uma visualização mais detalhada. Utilize as opções de download para salvar os gráficos em formatos como PNG ou SVG.")
